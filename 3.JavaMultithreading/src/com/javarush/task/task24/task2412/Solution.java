    ...
    public static void sort(List<Stock> list) {
        list.sort(new Comparator<Stock>() {
            ...
            public int compare(Stock stock1, Stock stock2) {
                // сначала делаем осртировку по имени, если имена одинаковые,то по дате,если даты одинаковые,то по разнице
                ...
                if (nameComparator != 0) {
                    ...
                    int dateComparator = date2.compareTo(date1); // чтобы новейшая дата была сверху
                    if (dateComparator != 0) {
                        ...
                        int changeComparator = change2.compareTo(change1); //чтобы сортировка прибыли была от положительных к отрицательным
